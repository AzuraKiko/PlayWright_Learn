...
export default defineConfig({
    ...
    use: {
        baseURL: 'https://wts.finavi.com.vn/', //URL cơ sở cho tất cả các test. Khi bạn sử dụng page.goto('/products'), nó sẽ điều hướng đến https://www.demoblaze.com/products.
