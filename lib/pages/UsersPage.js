...
class UsersPage extends BasePage {
    constructor(page) {
        ...
        this.showColumn = new ShowColumn(page);
        ...
        this.phoneNumberColumn = (rowIndex) => `//table//tr[${rowIndex + 1}]/td[10]`;
        this.userManagementColumn = (rowIndex) => `//table//tr[${rowIndex + 1}]/td[11]`;
        this.clientIdColumn = (rowIndex) => `//table//tr[${rowIndex + 1}]/td[12]`;
        this.clientSecretColumn = (rowIndex) => `//table//tr[${rowIndex + 1}]/td[13]`;
        this.langTigerUiColumn = (rowIndex) => `//table//tr[${rowIndex + 1}]/td[14]`;
        this.noteColumn = (rowIndex) => `//table//tr[${rowIndex + 1}]/td[15]`;
        this.actorColumn = (rowIndex) => `//table//tr[${rowIndex + 1}]/td[16]`;
        this.whiteLabelColumn = (rowIndex) => `//table//tr[${rowIndex + 1}]/td[17]`;
        this.lastTimeColumn = (rowIndex) => `//table//tr[${rowIndex + 1}]/td[18]`;
        this.createdTimeColumn = (rowIndex) => `//table//tr[${rowIndex + 1}]/td[19]`;
        this.lastUpdatedTimeColumn = (rowIndex) => `//table//tr[${rowIndex + 1}]/td[20]`;
        ...
        this.dynamicUserRow = DynamicLocators.create('//table//tr[td//span[contains(text(), "{0}")]]');
        this.dynamicUserRowActions = DynamicLocators.create('//table//tr[td//span[contains(text(), "{0}")]]//td[last()]//button');
    }
     ...
     */
    async openUsersPage() {
        await this.sidebar.navigateToAllUsers();
    ...
    async openActionsForUser(userLoginId) {
        const locator = this.dynamicUserRowActions(userLoginId);
